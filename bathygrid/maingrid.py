...
class SRGrid(MainGridBase, NumpyGrid):
    """
    ...
    def __init__(self, min_x: float = 0, min_y: float = 0, tile_size: float = 1024.0, output_folder: str = ''):
        MainGridBase.__init__(self)
        NumpyGrid.__init__(self, min_x=min_x, min_y=min_y, tile_size=tile_size, output_folder=output_folder)
        self.can_grow = True
...
class SRGridZarr(MainGridBase, ZarrGrid):
    """
    ...
    def __init__(self, min_x: float = 0, min_y: float = 0, tile_size: float = 1024.0, output_folder: str = ''):
        MainGridBase.__init__(self)
        ZarrGrid.__init__(self, min_x=min_x, min_y=min_y, tile_size=tile_size, output_folder=output_folder)
        self.can_grow = True
